      ...
      _createClass(SendOrderPage, [{
        ...
        value: function getSubtotal() {
          return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
            var i, _i6, _i7, _i8, _i9, _i10, descuento;
              ...
              while (1) {
                switch (_context3.prev = _context3.next) {
                  case 0:
                    ...
                    for (i = 0; i < this.g.fruits.length; i++) {
                      if (parseFloat(this.g.fruits[i].kg) > 0 || parseInt(this.g.fruits[i].pc, 10) > 0) {
                        this.subtotal += this.g.fruits[i].selectedWeight / 1000 * this.g.fruits[i].price;
                      }
                    }

                    for (_i6 = 0; _i6 < this.g.vegetables.length; _i6++) {
                    ...
                    for (_i7 = 0; _i7 < this.g.spices.length; _i7++) {
                    ...
                    for (_i8 = 0; _i8 < this.g.carnes.length; _i8++) {
                    ...
                    for (_i9 = 0; _i9 < this.g.cremeria.length; _i9++) {
                    ...
                    for (_i10 = 0; _i10 < this.g.otros.length; _i10++) {
                    ...
                    if (this.promo_seleccionada != null) {
                      if (this.promo_seleccionada.tipo == 'ENVIO') {
                        ...
                        descuento = this.subtotal * parseFloat("0." + this.promo_seleccionada.discount_price);
                    ...
                    _context3.next = 15;
                    return this.getCommissions(this.global.user_info.iduser);
        ...
        key: "getCommissions",
        value: function getCommissions(user_id) {
            ...
            return _regeneratorRuntime().wrap(function _callee5$(_context5) {
              while (1) {
                switch (_context5.prev = _context5.next) {
                  case 0:
                    this.apiService.getReferredCommissionsByUserId(user_id).subscribe(function (response) {
                      if (response.commissions.length >= 1) {
                        var total = 0;
                        var commisionsResponse = response.commissions;
                        Object.entries(commisionsResponse).forEach(function (_ref) {
                        ...
                        _this2.commissions = total;
                        _this2.total = _this2.total - total;
                      }
                    });
